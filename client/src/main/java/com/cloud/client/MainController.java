...
public class MainController implements Initializable {
    ...
    public void updateFileList(FileListMessage msg) {
    ...
    public void sendFilePartly(File selectedFile) {
    ...
    private boolean savePartFile(FilePartMessage msg) {
